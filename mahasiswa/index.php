...
<body>
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item">
                                        <a href="schedule_guidance.php" 
                                            aria-label="Toggle navigation">Jadwal Bimbingan</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="profil.html" class="page-scroll"
                                            aria-label="Toggle navigation">Profil</a>
                                    </li>
                                </ul>
                            </div> <!-- navbar collapse -->
                            <div class="button add-list-button">
                                <a href="form_jadwal.html" class="btn">Buat Jadwal TA Yuk</a>
                            </div>
                        </nav>
                        <!-- End Navbar -->
                    </div>
    ...
    <section id="home" class="hero-area">
        <div class="container">
            ...
            <p data-wow-delay=".6s" style="text-align: left; color: white;">Semangat Nufi! Ketika tugas menumpuk dan waktu terasa singkat ingatlah Fokus pada satu tugas dalam satu waktu. Jangan khawatirkan sempurna, tapi kerjakan sebisamu. Tiga hari adalah waktu yang cukup jika kamu melangkah dengan tekad. Ingat, perjuangan hari ini adalah pintu menuju keberhasilan di masa depan. 🌟</p>
        </div>
    </section>
    <!-- End Hero Area -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2 class="wow fadeInUp" data-wow-delay=".4s">Ada Tugas Apa Aja Nih?</h2>
                    </div>
                </div>
            </div>
            <div class="row">
